import CgPageLayout from '../components/ui/CgPageLayout';
...
export default {
    title: 'Components/CgPageLayout',
    component: CgPageLayout
}

const Template = args => <Router><CgPageLayout {...args} /></Router>
